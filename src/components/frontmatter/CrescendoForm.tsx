...
export function CrescendoForm({ meta, onChange }: Props) {
  ...
  return (
    <CollapsibleSection title="6. Crescendo" className="crescendo-form-section" defaultOpen={false}>
      <p className="field-hint">
        Book title, CTAs, and eyebrow are fixed on the site. Only the heading and body copy are
        per-article.
      </p>
